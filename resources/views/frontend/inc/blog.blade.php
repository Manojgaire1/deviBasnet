        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4 item">
                    ...
                    <p>
                       My opinion regarding the weakness of the previous NRNA about not acheiving the mission along with the role and upcoming planning of NRNA with Kapil Poudel on Nagarik Dainiki
                    </p>
                    <a href="https://www.facebook.com/Nayadainiki/videos/2819299258400747" class="btn btn-secondary" target="_blank">Read more...</a>
                </div>
                <div class="col-12 col-lg-4 item">
                    <img src="{{asset('front-assets/img/blog/blog2.png')}}" class="img-fluid" alt=""/>
